      ...
      >
        <el-form-item prop="phoneNo">
          <el-row class="uc-mobile-item">
            ...
            <el-col :span="17">
              <el-input v-model="ruleForm.phoneNo" placeholder="请输入手机号码"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
        ...
        <el-form-item prop="age">
          <el-row class="verificationbox">
            <el-col :span="24">
              <el-input v-model.number="ruleForm.age" placeholder="短信验证码"></el-input>
            </el-col>
            <el-col :span="7" class="verification">
              <el-button type="primary" :disabled="disabledB" size="mini">获取验证码</el-button>
            </el-col>
          </el-row>
        </el-form-item>
        ...
        <el-form-item prop="secondPassword">
          <el-input type="secondPassword" v-model="ruleForm.pass" placeholder="请再次输入密码"></el-input>
        </el-form-item>
        <el-form-item>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        age: [{ validator: ageNo, trigger: "blur" }]
      },
      numOp: [
        {
          label: "热门国家及地区",
