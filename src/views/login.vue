<template>
  <div class="page-container">
    <div class="logo">
      <img src="https://passport.bitdeer.com/logo.png" />
    </div>
    <div class="navs">
      <ul class="nav-list">
        <router-link :to="{ path: 'byPhone' }" active-class="active" tag="li">
          <a>手机注册</a>
        </router-link>
        <router-link :to="{ path: 'byEmail' }" active-class="active" tag="li">
          <a>邮箱注册</a>
        </router-link>
      </ul>
    </div>
    ...
    <div class="footer">
      ...
      <div class="links">
        ...
        <router-link  v-if="$route.query.info==='code'" class="middle" :to="{ path:'', query:{info:'pwd'}}">忘记密码</router-link>
        <router-link :to="{ path:'', query:{info:'pwd'}}"  class>注册账号</router-link>
      </div>
    </div>
  </div>
</template>
